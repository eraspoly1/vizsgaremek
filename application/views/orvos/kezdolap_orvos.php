<form class="form-inline my-2 my-lg-0" method="get" action="<?php echo base_url('kezdolap/index')?>">
		  ...
		  <button class="btn btn-info" type="submit"><a href="<?php echo base_url('kezdolap/index')?>">Részletes keresés</a></button>
	    </form>
		<br>
		<h1><p>Üdv újra <?php echo $this->session->userdata('felhasznalonev');?>!</p></h1>
		<p>Ez a felület ad lehetőséget az orvosoknak néhány dologra.</p>
		<p>Kattintgasd végig a menüpontokat további infóért.</p>
		<p>Ha idáig eljutottál, akkor az azt jelenti, hogy tudod regisztrálni a rendelőt ahol dolgozol, magadat, mint orvost, szolgáltatásokat és a hozzájuk tartozó állatorvosokat
			és persze a nyitvatartásról se feledkezz meg. 
		</p>
