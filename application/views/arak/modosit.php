<div class="container p-3 my-3 border">
    ...
    <?php else: ?>
        <h1>Ár módosítása</h1>
        <div class="container">
        <form method="post" action="<?php echo base_url(); ?>arak/modosit">
        <div class="form-group">
            <input type="hidden" name="id" value="<?php echo $ar['id'] ?>">
            <input type="text" class="form-control" name="ar" id="ar" placeholder="Ár" required 
            ...
            <div class="form-group">
            <input type="text" class="form-control" name="allat_id" id="allat_id" placeholder="Állat ID" required
            ...
            <input type="text" class="form-control" name="szolgaltatas_id" id="szolgaltatas_id" placeholder="Szolgáltatás ID" required
            ...
            <?php if ($this->session->userdata('last_request')): ?>
                ...
                <?php endif; ?>
            <?php else: ?>
                value="<?php echo $ar['szolgaltatas_id'] ?>"
            <?php endif; ?>
            >
            </div>
            <br>
